...
public class CreateStudentDB {
   public static void main(String[] args) {
      ...
      try (
         ...
         // Project Assignment 2.1: Create Index
         s = "create index majorid on STUDENT (MajorId)";
         stmt.executeUpdate(s);
         System.out.println("Index majorid on STUDENT (MajorId) is created.");
         
         // Project Assignment 2.3: Create Index
         s = "create index studentid on ENROLL (StudentId)";
         stmt.executeUpdate(s);
         System.out.println("Index studentid on ENROLL (StudentId) is created.");
